...
% Checkboxs
graficodsp.schroedercheck = uicontrol('parent',dspfigure,'style','checkbox','units','normalized','position',[0.43 0.635 0.06 0.035],...
    'string','Schroeder','BackGroundColor',[200/255 200/255 200/255]);
graficodsp.EDTcheck = uicontrol('parent',dspfigure,'style','checkbox','units','normalized','position',[0.43 0.605 0.06 0.035],...
    'string','EDT','BackGroundColor',[200/255 200/255 200/255]);
graficodsp.T10check = uicontrol('parent',dspfigure,'style','checkbox','units','normalized','position',[0.43 0.575 0.06 0.035],...
    'string','T10','BackGroundColor',[200/255 200/255 200/255]);
graficodsp.T20check = uicontrol('parent',dspfigure,'style','checkbox','units','normalized','position',[0.43 0.545 0.06 0.035],...
    'string','T20','BackGroundColor',[200/255 200/255 200/255]);
graficodsp.T30check = uicontrol('parent',dspfigure,'style','checkbox','units','normalized','position',[0.43 0.515 0.06 0.035],...
    'string','T30','BackGroundColor',[200/255 200/255 200/255]);

% Buttongroup
graficodsp_bg = uibuttongroup('parent', dspfigure,'units','normalized','position',[0.415 0.39 0.09 0.07],'title',...
...
graficosdsp_plot = uicontrol('parent',dspfigure,'style','pushbutton','string','Graficar','units','normalized',...
    'position',[0.42 0.47 0.08 0.035],'callback',...
...
graficodsp_export = uicontrol('parent',dspfigure,'style','pushbutton','string','Exportar gráfico','units','normalized',...
    'position',[0.42 0.315 0.08 0.035]);
